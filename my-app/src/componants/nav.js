  ...
  render() {
    return (
      <div id="nav-wrapper" className="nav-wrapper">
        <nav>
          <ul id="side-bar" className="side-bar">
            <NavLink to={"/home"}>
              <li>
                <img className="icon logo" src={rat} alt="rat" />
              </li>
            </NavLink>
            <NavLink
              activeClassName="active"
              className="link black width"
              to={"/home"}
            >
              <li className="align hover">
                <svg viewBox="0 0 24 24" className="icon">
                  {this.props.activeReducer === "Home" ? (
                    <g>
            ...
            >
              <li className="align hover">
                <svg viewBox="0 0 24 24" className="icon">
                  {this.props.activeReducer === "Explore" ? (
                    <g>
            ...
            >
              <li className=" align hover">
                <svg viewBox="0 0 24 24" className="icon">
                  {this.props.activeReducer === "Notification" ? (
                    <g>
            ...
            >
              <li className=" align hover">
                <svg viewBox="0 0 24 24" className="icon">
                  {this.props.activeReducer === "Messages" ? (
                    <g>
            ...
            >
              <li className=" align hover">
                <svg viewBox="0 0 24 24" className="icon">
                  {this.props.activeReducer === "Bookmarks" ? (
                    <g>
            ...
            >
              <li className=" align hover">
                <svg viewBox="0 0 24 24" className="icon">
                  {this.props.activeReducer === "Lists" ? (
                    <g>
            ...
            >
              <li className=" align hover">
                <svg viewBox="0 0 24 24" className="icon">
                  {this.props.activeReducer === "Profile" ? (
                    <g>
            ...
            <Link activeClassName="active" className="link black width">
              <li className=" align hover">
                <svg viewBox="0 0 24 24" className="icon">
                  <g>
            ...
            >
              <li className="align">
                <button className="btn d-hover">Squeak</button>
              </li>
            </Link>
            <li className="black align">
              <SignBar user={this.props.activeUserInfo}></SignBar>
            </li>
          </ul>
        </nav>
      </div>
